        ...
        >
          {items &&
            items.map((item) => (
              <DropdownMenu.Item
                key={item.lable}
                className={`${item.class} group relative flex h-[25px] cursor-pointer select-none items-center rounded-[3px] pl-[25px] pr-[5px] text-[11px] leading-none outline-none hover:bg-violet3 data-[disabled]:pointer-events-none data-[disabled]:text-mauve8`}
